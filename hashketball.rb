...
def num_points_scored(player_name)
  game_hash.each do |location, team_data|
    if team_data[:players].has_key?(player_name)
      return team_data[:players][player_name][:points] #this is returning all of :location
    end
  end
end
...
def player_numbers(team_name)
  ...
  game_hash.each do |location, team_data|
    if game_hash[location][:team_name] == team_name
      ...
      jerseys << game_hash[location][:players][player][:number]
    end
  end
end
  jerseys
...
#      biggest = shoe_array.max #finds biggest shoe size
